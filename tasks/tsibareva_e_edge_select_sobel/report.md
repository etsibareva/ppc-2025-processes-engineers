...
MPI реализация показала ускорение до 3 раз относительно последовательной реализации алгоритма умножения матрицы на вектор. Наблюдается линейное ухудшение эффективности, обусловленное ростом накладных расходов с увеличением количества процессов.
